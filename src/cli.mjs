...
function usage() {
  return [
    'Usage:',
    '  node src/cli.mjs inventory --provider <provider> --source <path> [limits]',
    '  node src/cli.mjs inventory --provider <provider> --source <path> --execute --output <path> --deltas <path> --checkpoint <path> --ledger-dir <path> [limits]',
    '  node src/cli.mjs related --provider <provider> --source <path> --ledger-dir <path> [--after-sequence <n>] [--include-self]',
    '  node src/cli.mjs reconcile --batch <json> --runtime-root <path> [--execute]',
    '  node src/cli.mjs sweep --config <json> --runtime-root <path> [--execute] [--minimum-interval-seconds <n>]',
    '  node src/cli.mjs context-refresh --provider <provider> --source <path> --ledger-dir <path> --runtime-root <path> [--execute --audit-dir <path>]',
    '  node src/cli.mjs context-route [--profile <id> | --task-kind <kind> | --project-scope] [--strict-isolation]',
    '  node src/cli.mjs context-query --provider <provider> --runtime-root <path> --scope-kind <kind> --scope-key <key> [--profile <id> | --task-kind <kind> | --project-scope] [--term <value> ...] [--strict-isolation]',
    '  node src/cli.mjs context-query ... --execute --global-audit-dir <path> [--ticket-package-root <path> --ticket-audit-root <path>] [--review-ledgers-root <path>] [--thread-ref <ref> --thread-audit-root <path>]',
    '  node src/cli.mjs context-publish --provider <provider> --proposal <json> --runtime-root <path> --event-runtime-root <path> [--ticket-packages-root <path>] [--review-ledgers-root <path>] [--execute]',
    '  node src/cli.mjs progress-publish --provider <provider> --proposal <json> --runtime-root <path> --event-runtime-root <path> [--ticket-packages-root <path>] [--review-ledgers-root <path>] [--execute]',
    '  node src/cli.mjs event-append --event <json> --runtime-root <path> [--execute]',
    '  node src/cli.mjs event-verify --runtime-root <path>',
    '  node src/cli.mjs event-repair --runtime-root <path> [--execute]',
    '  node src/cli.mjs read-model --runtime-root <path> [--read-model-root <path>] [--execute] [--strict-isolation]',
    '  node src/cli.mjs source-attest --attestation <json> --runtime-root <path> [--execute]',
    '  node src/cli.mjs source-verify --provenance <json> --runtime-root <path>',
    '  node src/cli.mjs correction-propose --proposal <json> --runtime-root <path> [--execute]',
    '  node src/cli.mjs correction-decide --decision <json> --runtime-root <path> [--execute]',
    '  node src/cli.mjs migrate-events --ledger-dir <path> --runtime-root <path> --event-runtime-root <path> [--execute]',
    '  node src/cli.mjs doctor --runtime-root <path> [--event-runtime-root <path>] [--read-model-root <path>]',
    '',
    'Limits:',
    '  --max-files <n>',
    '  --max-scan-bytes <n>',
